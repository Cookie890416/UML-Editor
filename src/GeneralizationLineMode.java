...
public class GeneralizationLineMode extends Mode{
	...
	public void mouseReleased(MouseEvent arg0){
		...
		if(selected_object_number != null){
			...
			//如果end_selected_object_number不是null，則建立GeneralizationLine物件並將它加入到UMLCanvas的物件Map中
			if(end_selected_object_number != null){
				GeneralizationLine generalization_line = new GeneralizationLine(Configure.GeneralizationLineBut_title, umlObjectMap.get(selected_object_number), umlObjectMap.get(end_selected_object_number));
				UMLCanvas.getInstance().addObjectToMap(generalization_line);
			}
		}
		//重繪UMLCanvas
	...
	public void drawDraggedLine(Graphics2D g2) {
		if(selected_object_number != null){
			...
			g2.drawLine((int)((x1+x2)*0.5), (int)((y1+y2)*0.5), (int)line_start_point.getX(), (int)line_start_point.getY());
